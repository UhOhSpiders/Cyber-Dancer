...
export function createDefaultLights(targetObject) {
  ...
  directionalLight1.fadeOutTween = createLightFade(
    directionalLight1,
    30,
    0,
    1000
  );
  directionalLight1.fadeInTween = createLightFade(
    directionalLight1,
    0,
    30,
    500
  ...
  directionalLight2.fadeOutTween = createLightFade(
    directionalLight2,
    30,
    0,
    1000
  );
  directionalLight2.fadeInTween = createLightFade(
    directionalLight2,
    0,
    30,
    500
  ...
  directionalLight3.fadeOutTween = createLightFade(
    directionalLight3,
    5,
    0,
    1000
